...
run_compose() {
    ...
    docker pull lscr.io/linuxserver/docker-compose:latest || fatal "Failed to pull latest docker-compose image.\nFailing command: ${F[C]}docker pull lscr.io/linuxserver/docker-compose:latest"

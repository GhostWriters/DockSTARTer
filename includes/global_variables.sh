...
declare -rgx APPLICATION_ASSETS_FOLDER="${SCRIPTPATH}/assets"
...
declare -rgx EXTRACTED_THEME_FILE="${TEMP_FOLDER}/${THEME_FILE_NAME}"

declare -gx APPLICATION_CONFIG_FOLDER="${XDG_CONFIG_HOME}/${APPLICATION_NAME,,}"
declare -gx USER_THEMES_FOLDER="${APPLICATION_CONFIG_FOLDER}/${THEME_FOLDER_NAME}"
declare -gx ACTIVE_THEME_FILE="${APPLICATION_STATE_FOLDER}/theme${THEME_FILE_EXT}"
